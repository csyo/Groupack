...
function searchsession(){
	$.post('http://chding.es.ncku.edu.tw/Groupack/searchsession.php', { fbid: localStorage.FB_id, fbname:localStorage.FB_name, keyword:localStorage.k_word, gid:localStorage.group_selected })
	.fail( function(xhr) { console.log(xhr) })
