...
$(document).ready(function(e){
	...
	$(window).resize(function(){   
	    ...
	    function get_search_topics(){  
			...
			$.ajax({         
			url: 'http://chding.es.ncku.edu.tw/Groupack_new/TopicMap/getSearchTopic.php',         
			cache: false,         
			dataType: 'html',     
			type: 'POST',        
			async: false,
		...
		function get_topic_member(){
			...
			$.ajax({         
			url: 'http://chding.es.ncku.edu.tw/Groupack_new/TopicMap/get_Topicmembers.php',         
			cache: false,         
			dataType: 'html',     
			type: 'POST',         
			async: false,
		...
		function get_topic_relevance() {
			...
			***										**/
			...
			$.ajax({
				...
				success: function (response) {
					sessionStorage.setItem('topic_relevance_for' + localStorage.group_selected,response);	 
				}
			});
		}		
		function testdevice(){
